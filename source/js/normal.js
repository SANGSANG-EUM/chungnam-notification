...
const tabDep1 = () => {
  $('.poster-tab-li button').on('click', function(){
    let tabLi = $(this).parents('.poster-tab-li');
    let tabLiOrder = tabLi.index();

    $('.poster-tab-li').removeClass('active');
    tabLi.addClass('active');
    $('.poster-box').removeClass('active');
    $('.poster-box').eq(tabLiOrder).addClass('active');
  });
}
